...
/* Bring in an "addEducation()" action. */
...
const AddEducation = ({ addEducation, history }) => {
  ...
  /* We need to have a "to" propery disabled if a "current" property is "true". Because if the user has the current learning now, there's no sense in the "to" property. 
    ...
    <Fragment>
      ...
      <form 
        ...
        onSubmit={
          e => {
            e.preventDefault();
            /* Call our action of "addEducation()". 
            It's gonna take in the formData, and we're gonna do redirect so we need to pass in a "history", which is a part of our props.
            Once we submit, it should call the "addEducation()" action, pass in the data (formData), make the request and add an experience. */
...
export default connect(
  ...
  null,
  { addEducation }
/* In order to use the "history" object (if we're gonna pass that in somewhere) we need to use "withRouter()" method. So here in the second set of the "connect()" parentheses we're gonna pass in "withRouter()" in which we're gonna pass in the "AddEducation" component as an argument.
