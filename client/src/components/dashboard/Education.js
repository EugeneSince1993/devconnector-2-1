...
/* As far as props we're gonna have the educations (learnings) passed in from the parent component which is gonna be "Dashboard.js". So educations (learnings) will be passed in as the "education" item. */
